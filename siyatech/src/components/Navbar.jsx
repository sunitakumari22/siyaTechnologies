  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse text-light " id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <Link className="nav-link text-light" to="/signup">About</Link>
        </li>
        <li className="nav-item">
          <Link className="nav-link text-light" to="/">Experience</Link>
        </li>
        <li className="nav-item">
          <Link className="nav-link text-light" to="/">Services</Link>
        </li>
        <li className="nav-item">
